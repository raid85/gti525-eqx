...
<div id="wrapper">
	<div id="page">
	  ...
	  function checkEmail() {
            if (/^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/.test(form.CourrielClient.value)){
            return true;
            }
            return false; 
          }
          ...
          function validate(){
            ...
            if((CourrielClient.value==null)||(CourrielClient.value=="")){
            ...
            if((VilleClient.value==null)||(VilleClient.value=="")){
            ...
            if((ProvinceClient.value==null)||(ProvinceClient.value=="")){
            ...
            if((CCClient.value==null)||(CCClient.value=="")){
                ...
                if((ExpMClient.value==null)||(ExpMClient.value=="")){
                    ...
                    if((ExpAClient.value==null)||(ExpAClient.value=="")){
		...
		<div id="content">
			...
			<ul align='left'>
								...
								<li>Ville :<input type="text" name="VilleClient" value='Montreal' /></li>
								<li>Province :<input type="text" name="ProvinceClient" value='Quebec' /></li>
								...
								<li>Mois Expiration :<input type="text" name="ExpMClient" value='12' /></li>
								<li>Année Expiration :<input type="text" name="ExpAClient" value='14' /></li>
								<li>Code de sécurité :<input type="text" name="SecClient" value='123' /></li>
